...
@primary-fill: #e1e1e1;     // Lighter version of the original #999999
@secondary-fill: #e1e1e1;   // Lighter version of the original #c6c6c6
@motorway-low-zoom: #e1e1e1; // Lighter version of the original #5e5e5e
@trunk-low-zoom: #e1e1e1;    // Lighter version of the original #777777
@primary-low-zoom: #e1e1e1;  // Lighter version of the original #919191
@secondary-low-zoom: #e1e1e1; // Lighter version of the original #ababab
...
@secondary-shield: #e1e1e1; // Lighter version of the original #474747
